...
/// A city for the world clock display.
...
pub struct Config {
    ...
    /// Show day of week in panel (e.g., "Thu")
    #[serde(default = "default_true")]
    pub panel_show_weekday: bool,
    /// Show year in panel (e.g., "2026")
    #[serde(default)]
    pub panel_show_year: bool,
    ...
    // ===== Weather Settings =====
    /// City for weather display (`None` = weather disabled).
    #[serde(default)]
    pub weather_city: Option<WeatherCity>,

    // ===== World Clock Settings =====
    /// Cities for world clock (up to 3, empty = disabled).
    #[serde(default)]
...
impl Default for Config {
    fn default() -> Self {
        Self {
            // Panel display defaults
            panel_show_weekday: true,
            panel_show_year: false,

            // Meeting/calendar defaults
